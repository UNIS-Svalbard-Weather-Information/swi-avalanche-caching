...
class AvalancheForecastProcessing:
    ...
    def __init__(self, n_days_forecast=2, regions_list=None, serve_only=False):
        """
    ...
    def _create_forecast_layer_region_shape(self, region_info):
        try:
            ...
            # Initialize a dictionary to hold the results for each date
            results = {}
            ...
            for date, forecast in forecasts.items():
                ...
                # Initialize a counter for problem_id for this date

                # Store empty lists and dictionaries for this date
                results[date] = {
                    "gdf": None,
                    "legend": None,
                    "url": full_url,
                ...
                if (
                    ...
                    for problem in forecast["AvalancheProblems"]:
                        ...
                        legend_dict[problem_id] = {
                            "label": label,
                            "description": problem[
                                "TriggerSenitivityPropagationDestuctiveSizeText"
                            ],
                            "cause_name": problem["AvalCauseName"],
                            "orientation_str": " ".join(orientation_list),
                            "orientation_bin": problem["ValidExpositions"],
                            "e1": e1,
                            "e2": e2,
                        }
                    ...
                    results[date]["gdf"] = pd.concat(gdf_list)
                    results[date]["legend"] = legend_dict
            return results
